import {
    ...
    NumberInput, NumberInputField, State, useHookstate,
    useForm, VStack, useState, Text, useGranularEffect,
} from '@src/libs'
import { appStore, AppStoreType, appStaticStore, appValidators, GraphQlQueryResultType, Messages,  useDialogs, useAppGraphql, AppRequiredAstrisk, useFeedback, debounceFilterOn, ebukiMessages, debounceEmit, } from '@src/features'
...
function SuperAdminEditNewClientExtDatabase() {
    ...
    const defaultData = store.modalDialogA.get({noproxy:true}).defaultData
