import { appStore, GraphQlQueryResultType, Messages, useAppGraphql, } from '@src/features'
import { DeleteIcon, EditIcon, HideIcon, IconButton, Tooltip, FC, useToast } from '@src/libs'
...
function useComponentHistory() {
  function addToComponentHistory(componentName: componentNames) {
    appStore.componentHistorySet.add(componentName.toString())
  }

  function removeFromComponentHistory(componentName: componentNames) {
    appStore.componentHistorySet.delete(componentName.toString())
  }

  function isInComponentHistory(componentName: componentNames): boolean {
    return appStore.componentHistorySet.has(componentName.toString())
  }
