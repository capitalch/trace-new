import { AlertDialog, AlertDialogHeader, AlertDialogBody, useRef, AlertDialogOverlay, AlertDialogContent, Heading, AlertDialogFooter, Button, CloseButton, HStack, } from '@src/libs'
...
function AppAlertDialogYesNo() {
    ...
    function handleYes() {
        ...
        appStore.alertDialogYesNo.action()
        appStore.alertDialogYesNo.isOpen.value = false
    }
}
